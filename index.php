...
?> 
    ...
    <section class="container my-5">
        ...
        <!-- <div class="row row-cols-1 row-cols-md-2 my-3 g-5">
            <div class="col"> -->
        <div class="p-3">
            <div class="card bg-transparent mb-4 h-100 border-0 ">
                <div class="row">
                    <div class="col-md-5">
                        <img class="rounded-3 fixed-size-img w-auto" src="assets/images/Designer.jpeg" alt="card img">
                    </div>
            ...
            <div class="card bg-transparent mb-4 h-100 border-0">
                <div class="row">
                    <div class="col-md-5 ">
                        <img class="rounded-3 fixed-size-img  w-auto" src="assets/images/BACKGROUND.jpeg" alt="" >
                    </div>
                    <div class="col-md-7 mt-3 mt-md-0">
                        <a href="#" class="badge bg-info mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Sports</a>
                        <h3><a href="#" class="btn-link stretched-link text-dark fw-bold">5 reasons why you shouldn't startup</a></h3>
