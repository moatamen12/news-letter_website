    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 p-3 bg-primary bg-opacity-10 sidebar shadow-sm">
            ...
            <div class="profile-sidebar-user mb-4">
                <div class="d-flex align-items-center mb-3">
                    <img src="<?= htmlspecialchars(BASE_URL . $profile_photo) ?>" alt="Profile" 
            ...
            <ul class="nav nav-pills flex-column" id="profileTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link w-100 text-start" id="social-tab" data-bs-toggle="pill" 
                            data-bs-target="#social-content" type="button" role="tab">
                        <i class="fa-solid fa-inbox"></i> My News Letter
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link w-100 text-start" id="password-tab" data-bs-toggle="pill" 
                        ...
                        <i class="fa-solid fa-table-columns"></i> Dasheboard
                    </button>
                </li>
                <li class="nav-item" role="presentation">
        ...
        <div class="col-md-9 col-lg-10 p-4">
            ...
            <div class="tab-content" id="profileTabContent">
                ...
                <!-- Empty tab panes for future use -->
                <div class="tab-pane fade" id="social-content" role="tabpanel" aria-labelledby="social-tab"></div>
