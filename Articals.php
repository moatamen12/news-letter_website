    ...
    <div class="row g-4">
        ...
        <div class="col-md-12  order-2">
            ...
            <div class="card bg-transparent mb-4 border-0">
                <div class="row g-3">
                    <div class="col-md-5">
                        <img class="rounded-3 img-fluid article-card-img" src="assets/images/BACKGROUND.jpeg" alt="">
                    </div>
                    <div class="col-md-7">
                        <a href="#" class="badge bg-info mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Sports</a>
                        <h3><a href="#" class="btn-link text-dark fw-bold">5 reasons why you shouldn't startup</a></h3>
                        <p>Given and shown creating curiously to more in are man were smaller by we instead the these sighed Avoid in the sufficient me real man longer of his how...</p>
                        <!-- Card info -->
                        <ul class="nav align-items-center">
                            <li class="nav-item">
            ...
            <div class="card bg-transparent mb-4 border-0">
                <div class="row g-3">
                    <div class="col-md-5">
                        <img class="rounded-3 img-fluid article-card-img" src="assets/images/background.webp" alt="">
                    </div>
                    <div class="col-md-7">
                        <a href="#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                        <h3><a href="#" class="btn-link text-dark fw-bold">Best Pinterest boards for learning about business</a></h3>
            ...
            <div class="card bg-transparent mb-4 border-0">
                <div class="row g-3">
                    <div class="col-md-5">
                        <img class="rounded-3 img-fluid article-card-img" src="assets/images/Designer.jpeg" alt="">
                    </div>
                    <div class="col-md-7">
                        <a href="#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                        <h3><a href="#" class="btn-link text-dark fw-bold">Best Pinterest boards for learning about business</a></h3>
            ...
            <div class="card bg-transparent mb-4 border-0">
                <div class="row g-3">
                    <div class="col-md-5">
                        <img class="rounded-3 img-fluid article-card-img" src="assets/images/introduction-background.png" alt="">
                    </div>
                    <div class="col-md-7">
                        <a href="#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                        <h3><a href="#" class="btn-link text-dark fw-bold">Best Pinterest boards for learning about business</a></h3>
            ...
            <div class="card bg-transparent mb-4 border-0">
                <div class="row g-3">
                    <div class="col-md-5">
                        <img class="rounded-3 img-fluid article-card-img" src="assets/images/Screenshot 2025-02-11 213358.png" alt="">
                    </div>
                    <div class="col-md-7">
                        <a href="#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                        <h3><a href="#" class="btn-link text-dark fw-bold">Best Pinterest boards for learning about business</a></h3>
            ...
            <div class="card bg-transparent mb-4 border-0">
                <div class="row g-3">
                    <div class="col-md-5">
                        <img class="rounded-3 img-fluid article-card-img" src="assets/images/su.jpg" alt="">
                    </div>
                    <div class="col-md-7">
                        <a href="#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                        <h3><a href="#" class="btn-link text-dark fw-bold">Best Pinterest boards for learning about business</a></h3>
            ...
            <div class="card bg-transparent mb-4 border-0">
                <div class="row g-3">
                    <div class="col-md-5">
                        <img class="rounded-3 img-fluid article-card-img" src="assets/images/subscipe_bg.jpg" alt="">
                    </div>
                    <div class="col-md-7">
                        <a href="#" class="badge bg-danger mb-2"><i class="fas fa-circle me-2 small fw-bold"></i>Technology</a>
                        <h3><a href="#" class="btn-link text-dark fw-bold">Best Pinterest boards for learning about business</a></h3>
