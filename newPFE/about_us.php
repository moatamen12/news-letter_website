...
<!-- Hero Section -->
<section class="m-5 py-5 text-center rounded text-white d-flex align-items-center" style="background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.7)), url('assets/images/about_us_bg.jpg') center/cover no-repeat; min-height: 400px; ">
